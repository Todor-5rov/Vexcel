...
import { Send, Bot, User, Zap, MessageSquare, AlertTriangle, Cloud, FolderSyncIcon as Sync } from "lucide-react"
...
export default function ChatInterface({
  ...
  // Update welcome message when data changes
  useEffect(() => {
  ...
  }, [currentData, headers, mcpFilePath])
